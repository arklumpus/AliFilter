...
namespace Figures_1_S1_S2_S4
{
    ...
    {
        public static void CreateFigureS4()
        {
            ...
            fullPage.SaveAsSVG("Figure_S4.svg");
            fullPage.SaveAsSVG("Figure_S4.notext.svg", SVGContextInterpreter.TextOptions.ConvertIntoPathsUsingGlyphs);
            doc.SaveAsPDF("Figure_S4.pdf");
            fullPage.SaveAsPNG("Figure_S4.png", 600 / 72.0);
        }
    }
}
